...
function getTransporter() {
  ...
  transporter = nodemailer.createTransport({
    host,
    port,
    secure: port === 465, // true untuk 465 (SMTPS), false untuk 587 (STARTTLS)
    auth: { user, pass },
    connectionTimeout: 10000, // 10 detik: batasi koneksi agar tidak hanging
...
// Kirim email OTP.
// Mengembalikan false hanya jika SMTP BELUM dikonfigurasi (mode demo).
// Jika SMTP terkonfigurasi tapi gagal, error dilempar agar API bisa balas 500 cepat.
