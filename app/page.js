...
export default function Home() {
  ...
  if (!isLoggedIn) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#09090b] text-[#ededed] px-4 font-sans relative overflow-hidden">
        {/* Decorative Glowing Gradients */}
        <div className="absolute top-[-20%] left-[-10%] w-[500px] h-[500px] bg-[#ff3b70] opacity-[0.06] rounded-full blur-[120px] pointer-events-none" />
        <div className="absolute bottom-[-20%] right-[-10%] w-[500px] h-[500px] bg-[#8b5cf6] opacity-[0.06] rounded-full blur-[120px] pointer-events-none" />

        <div className="flex flex-col items-center mb-8 text-center animate-fade-in">
          {/* Logo Circle */}
          <div className="w-14 h-14 rounded-full bg-gradient-to-tr from-[#ff3b70] to-[#8b5cf6] flex items-center justify-center mb-4 shadow-[0_0_20px_rgba(255,59,112,0.3)] animate-pulse-slow">
            <Zap className="w-7 h-7 text-white fill-white" />
          </div>
          <h1 className="text-3xl font-bold tracking-tight text-white flex items-center gap-2">
            <span className="gradient-text">Electric Pulse</span>
          </h1>
          <p className="text-xs text-[#8b8b9a] tracking-widest mt-1.5 uppercase font-medium">Admin Portal</p>
        </div>
        ...
        <div className="mt-12 text-center text-[10px] text-[#50505f] font-medium flex flex-col gap-2">
          <span>&copy; 2026 VibeVault Entertainment Group. All rights reserved.</span>
          <div className="flex gap-4 justify-center text-[#8b8b9a]">
